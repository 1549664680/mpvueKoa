<template>
  <div class="index">
    ...
    <div class="newcategory">
      <div class="list" v-for="(item, index) in newcategroyList" :key="index">
...
export default {
  ...
  methods:{  
    ...
    toMappage(){
      // 通过我们的 wx.getSetting 先查询下用户是否授权 scoped.record
      let _this = this
      wx.getSetting({
        success:(res) => {
          // 查询到如果没有同意授权， 打开设置
    ...
    getCityName(){
      let _this = this
      var myAmapFun = new amapFile.AMapWX({key:'48e85651b794aefd05f632604456cc6b'});
      myAmapFun.getRegeo({
    ...
    async getData() {
      ...
      this.newcategroyList = data.newcategroyList
    },
    categroyList(id){
      wx.navigateTo({
